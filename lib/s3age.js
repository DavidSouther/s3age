  ...
  */
  ...
  function S3age(selector, defaults) {
    ...
    if (!(typeof Detector !== "undefined" && Detector !== null ? Detector.webgl : void 0)) {
      return Detector.WebGLErrorMessage.add();
    }
    ...
    if (typeof this.controls === "function") {
      this.controls = new this.controls(this.scene, this._container);
    }
...
S3age.Renderer = function(stage, defaults) {
  ...
  ["setClearColor", "setDepthTest", "setDepthWrite", "setBlending", "setClearColorHex"].forEach(function(method) {
    ...
    if (defaults[method] != null) {
      ...
      switch (args.length) {
        case 1:
          return renderer[method](args[0]);
        case 2:
          return renderer[method](args[0], args[1]);
        case 3:
          return renderer[method](args[0], args[1], args[2]);
        case 4:
          return renderer[method](args[0], args[1], args[2], args[3]);
      }
    }
  });
